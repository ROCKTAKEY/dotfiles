...
(define skk-kana-toggle-key '("<IgnoreShift>@"))
(define skk-kana-toggle-key? (make-key-predicate '("<IgnoreShift>@")))
...
(define skk-sticky-key '("Muhenkan"))
(define skk-sticky-key? (make-key-predicate '("Muhenkan")))
